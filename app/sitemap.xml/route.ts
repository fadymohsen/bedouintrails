...
const STATIC_LAST_MODIFIED: Record<string, Date> = {
  ...
  "/camel-trek": new Date("2026-09-19"),
  ...
  "/white-desert-egypt": new Date("2026-09-19"),
  "/desert-trekking-egypt": new Date("2026-09-19"),
  "/white-desert-safari": new Date("2026-09-19"),
  "/siwa-oasis-tour": new Date("2026-08-24"),
  "/egypt-desert-tour": new Date("2026-09-19"),
