...
export default async function EgyptSafariToursPage() {
  ...
  return (
    <div className={styles["guide-page"]}>
      ...
      <GuideHero src="/img/egypt-safari-camel-trek.webp" alt="Egypt safari tours camel trekking White Desert" h1={t("guide_safaritours_h1")} objectPosition="center 70%" path={PATH} />
